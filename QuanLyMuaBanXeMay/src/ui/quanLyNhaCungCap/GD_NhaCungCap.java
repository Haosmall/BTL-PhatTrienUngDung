...
public class GD_NhaCungCap extends JPanel {
	...
	public GD_NhaCungCap() {
		...
		lblXeMay = new JLabel("Quản lý nhà cung cấp");
		...
		btnDau = new JButton("");
		btnDau.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_fast_rewind_white_24dp.png")));
		...
		btnTruoc.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_skip_previous_white_24dp.png")));
		...
		btnSau = new JButton("");
		btnSau.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_skip_next_white_24dp.png")));
		...
		btnCuoi = new JButton("");
		btnCuoi.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_fast_forward_white_24dp.png")));
		...
		btnXemChiTiet.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_error_outline_white_18dp.png")));
		...
		btnXoa.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_delete_sweep_white_18dp.png")));
		...
		btnCapNhat.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_construction_white_18dp.png")));
		...
		btnThem.setIcon(new ImageIcon(GD_NhaCungCap.class.getResource("/img/baseline_create_new_folder_white_18dp.png")));
