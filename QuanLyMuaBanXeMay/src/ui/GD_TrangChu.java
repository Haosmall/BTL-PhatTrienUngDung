...
public class GD_TrangChu extends JPanel {
	...
	public GD_TrangChu() {
		...
		tblXe.setModel(new DefaultTableModel(
			...
			new String[] {
				"M\u00E3 xe", "T\u00EAn xe", "H\u00E3ng", "Nh\u00E0 cung c\u1EA5p", "S\u1ED1 l\u01B0\u1EE3ng", "Gi\u00E1", "B\u1EA3o h\u00E0nh"
			}
		));
		...
		horizontalBox_5.add(lblMau);
		
		Component rigidArea_13_1_1 = Box.createRigidArea(new Dimension(20, 20));
		horizontalBox_5.add(rigidArea_13_1_1);
		
		comboBox = new JComboBox<String>();
		comboBox.setPreferredSize(new Dimension(165, 40));
		comboBox.setMaximumSize(new Dimension(32767, 40));
		comboBox.setFont(new Font("Tahoma", Font.PLAIN, 20));
		horizontalBox_5.add(comboBox);
		...
		btnXemChiTiet.setIcon(new ImageIcon(GD_TrangChu.class.getResource("/img/baseline_error_outline_white_18dp.png")));
		...
		horizontalBox_5_2.add(btnXemChiTiet);
		...
		lblThongTinHoaDon = new JLabel("Chi tiết hóa đơn");
		...
		tblHoaDon.setModel(new DefaultTableModel(
			...
			new String[] {
				"STT", "M\u00E3 xe", "T\u00EAn xe", "H\u00E3ng", "M\u00E0u", "s\u1ED1 l\u01B0\u1EE3ng", "Gi\u00E1 b\u00E1n", "B\u1EA3o h\u00E0nh"
			}
		));
		...
		pnlThanhToan.setBorder(new TitledBorder(null, "Thanh to\u00E1n", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnXoa.setIcon(new ImageIcon(GD_TrangChu.class.getResource("/img/baseline_remove_shopping_cart_white_18dp.png")));
		...
		btnNewButton_1.setMaximumSize(new Dimension(200, 50));
		btnNewButton_1.setPreferredSize(new Dimension(180, 50));
		btnNewButton_1.setForeground(Color.WHITE);
		btnNewButton_1.setFont(new Font("Tahoma", Font.BOLD, 18));
		horizontalBox_9.add(btnNewButton_1);
		...
		btnNewButton_2.setIcon(new ImageIcon(GD_TrangChu.class.getResource("/img/baseline_edit_white_18dp.png")));
		btnNewButton_2.setPreferredSize(new Dimension(110, 50));
		btnNewButton_2.setMaximumSize(new Dimension(200, 50));
		btnNewButton_2.setForeground(Color.WHITE);
		btnNewButton_2.setFont(new Font("Tahoma", Font.BOLD, 18));
		horizontalBox_10.add(btnNewButton_2);
		...
		btnThanhToan.setIcon(new ImageIcon(GD_TrangChu.class.getResource("/img/baseline_monetization_on_white_18dp.png")));
