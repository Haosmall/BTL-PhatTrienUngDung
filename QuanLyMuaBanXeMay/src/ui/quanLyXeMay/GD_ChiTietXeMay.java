...
public class GD_ChiTietXeMay extends JFrame implements ActionListener {
	...
	public GD_ChiTietXeMay() {
		...
		JLabel lblNewLabel_1_1_2_2_1 = new JLabel("Xuất sứ:");
		...
		JLabel lblXuatSu = new JLabel("Việt nam");
		lblXuatSu.setForeground(Color.GRAY);
		lblXuatSu.setFont(new Font("Tahoma", Font.BOLD, 20));
		horizontalBox_3_2.add(lblXuatSu);
