...
public class GD_ThemXeMay extends JPanel implements ActionListener {
	...
	public GD_ThemXeMay() {
		...
		JPopupMenu popupMenuXuatSu = new JPopupMenu();
		popupMenuXuatSu.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		addPopup(cboXuatSu, popupMenuXuatSu);

		JMenuItem mntmThemXuatSu = new JMenuItem("Thêm xuất sứ");
		mntmThemXuatSu.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		popupMenuXuatSu.add(mntmThemXuatSu);

		JMenuItem mntmSuaXuatSu = new JMenuItem("Sửa xuất sứ");
		mntmSuaXuatSu.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		popupMenuXuatSu.add(mntmSuaXuatSu);

		JMenuItem mntmXoaXuatSu = new JMenuItem("Xóa xuất sứ");
		mntmXoaXuatSu.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		popupMenuXuatSu.add(mntmXoaXuatSu);
